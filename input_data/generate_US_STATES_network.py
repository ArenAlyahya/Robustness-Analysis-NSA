...
f_matrix_original, codes = flow_matrix.generate_flow_matrix('processed_state_to_state_data2023.csv')  
...
file_out = open('US_STATES_network.csv','w')
...
file_out = open('US_STATES_network_codes.csv','w')
for i in range(N):
